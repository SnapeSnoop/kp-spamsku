        ...
        <form role="form" action="<?= base_url() . 'petugas/action_tambah' ?>" method="POST">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control datepicker" id="exampleInputPassword1" name="tgl_lahir" placeholder="Tanggal Lahir">
            </div>
            <div class="form-group">
        ...
        <form role="form" action="<?= base_url() . 'petugas/action_edit' ?>" method="POST">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="nama" name="nama_petugas" placeholder="Nama Petugas">
            </div>
            <div class="form-group">
              <label for="exampleInputPassword1">Tempat Lahir</label>
...
<script type="text/javascript">
  function select_data($idptgs, $nama_petugas, $tempat_lahir, $tanggal_lahir, $jk, $alamat, $nohp, $email) {
    $("#idptgs").val($idptgs);
